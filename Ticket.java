...
public class Ticket {
	...
	public Ticket() {price = -1; //special value showing that it is not initialized 
	};
	...
	public Ticket(Movie movieChosen, Seat seat, Cineplex cineplex, Cinema cinema, LocalDate date, MovieSlot slot) {
		...
		this.date = date;
		this.slot = slot;
		this.transactionID = String.valueOf(cineplex.getID())+String.valueOf(cinema.getCinemaID())+dtf.format(now); 
